...
export function Hero() {
    ...
    return (
        <Section
            ...
            className="min-h-screen flex items-center justify-center pt-32 pb-20 bg-[radial-gradient(circle_at_50%_50%,_rgb(255,245,245)_0%,_rgb(255,255,255)_50%,_rgb(249,250,251)_100%)] relative overflow-hidden"
        >
